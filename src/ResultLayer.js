...
var ResultLayer = cc.Layer.extend({
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            itemRestart.setPosition(355, 260);
    ...
    showStar:function(starIndex){
        ...
        switch(starIndex){
            case 0:
                this.mStarSprites[starIndex].setPosition(260,345);
                break;
            case 1:
                this.mStarSprites[starIndex].setPosition(360,365);
                break;
            case 2:
                this.mStarSprites[starIndex].setPosition(460,345);
                break;
        }
