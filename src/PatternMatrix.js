var MATRIX_CONTINUOUS = 3;
 ...
 var MATRIX_ROW_MAX = 8;
 var MATRIX_COL_MAX = 8;

var gPatternsFallTime = 0.35;
var gPatternsSwapTime = 0.17;
var gPatternsClearTime = 0.2;
...
var PatternMatrix = cc.Layer.extend({
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            this.PatternBg = cc.RenderTexture.create(600, 480);
            this.PatternBg.setPosition(305, 240);
    ...
    initMatrix:function(){
        ...
        this.m_nFreezeProbability = 0;
        this.m_nStoneProbability = 0;
        this.m_nBombProbability = 0;
        ...
        var baseX = 355.0 + halfSpace - this.m_nMatrixCol*halfSpace;  // set position of jewels in X
        var baseY = 335.0 + halfSpace - this.m_nMatrixRow*halfSpace;  // set position of jewels in Y
        var patternBg;
        var row,col;
    ...
    initProgressWithGameMode:function(){
        ...
        this.mProgressBgSpr.setPosition(230,100);
        ...
        this.mProgressSpr.setPosition(230,100);
    ...
    initLabels:function(){
        ...
        this.mScoreLabel.setPosition(350,590);
